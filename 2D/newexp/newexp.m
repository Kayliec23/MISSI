...
%   cluster = 'hoffman2';
%   queue = 'all.q';
%   if (is_hires) %%% 768 x 480 x 70, ~5km grid spacing
%     sNx = 48; %%% no. of x-gridpoints per tile
...
%   else %%%  384 x 240 x 70, ~10km grid spacing
...
% %     sNx = 48; %%% no. of x-gridpoints per tile
% %     sNy = 80; %%% no. of y-gridpoints per tile
...
%    Nr = 140;    %%% no. of z-gridpoints  
  ...
  switch(cluster)
    ...
    case 'stampede2'
      ...
      toolsdir = fullfile('/scratch/09369',username,'/MITgcm_IP/tools/');
      clusterdir = fullfile('/scratch/09369',username,'/MITgcm_IP/experiments/',batch_name);      
    ...
    case 'hoffman2'
     ...
     toolsdir = '/u/scratch/k/kaylie/MITgcm_IP/tools/';
     clusterdir = ['/u/scratch/k/kaylie/MITgcm_IP/experiments/',batch_name];
